...
import cn.edu.bjtu.gymclub.activity.TrainerListActivity;
...
public class FragmentThree extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_trainers = view.findViewById(R.id.btn_trainers);
    ...
    private void onClickShare() {
        ...
        params.putString(QQShare.SHARE_TO_QQ_APP_NAME, "Gym Club");
    ...
    private void shareToQQzone() {
        try {
            ...
            params.putString(QzoneShare.SHARE_TO_QQ_TITLE, "Gym Club");
